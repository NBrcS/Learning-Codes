...
export class CourseService {
  ...
  retrieveById(courseId: number): Observable<Course> {
...
var COURSES: Course[] = [
  {
    ...
    rating: 3,
    price: 12.99,
    imageUrl: '/src/assets/imgs/cli.png',
  },
  {
    id: 2,
    name: 'Angular: Forms',
    ...
    rating: 3.5,
    price: 24.99,
    imageUrl: '/src/assets/imgs/forms.png',
  },
  {
    id: 3,
    name: 'Angular: HTTP',
    ...
    rating: 4.0,
    price: 36.99,
    imageUrl: '/src/assets/imgs/http.png',
  },
  {
    id: 4,
    name: 'Angular: Router',
    ...
    rating: 4.5,
    price: 46.99,
    imageUrl: '/src/assets/imgs/router.png',
  },
  {
    id: 5,
    ...
    rating: 5,
    price: 56.99,
    imageUrl: '/src/assets/imgs/animations.png',
  },
];
